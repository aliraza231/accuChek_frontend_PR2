...
import { API_Admin_SignIn } from './../../../constants/contant';
import adminSigninSchema from '../../../services/validationService/adminJoiValidation/adminSigninValidation/adminSigninValidation';
...
const [passwordType, setPasswordType] = useState('password');
  ...
  const validateProperty = (name, value) => {
    ...
    const subSchema = { [name]: adminSigninSchema[name] };
