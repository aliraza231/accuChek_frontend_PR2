...
import {API_Admin_AddProduct} from "../../../../../constants/contant";
import adminAddProductValidationSchema from "../../../../../services/validationService/adminJoiValidation/adminAddProductValidation/adminAddProductValidation";
const AddProduct = () => {
  ...
  const validateProperty = (name, value) => {
    ...
    const subSchema = { [name]: adminAddProductValidationSchema[name] };
  ...
  let handleSubmit = async (e) => {
    ...
    Swal.fire({
      ...
      console.log(error);
        ...
        let isValid = true;
        for (let field in adminAddProductValidationSchema) {
