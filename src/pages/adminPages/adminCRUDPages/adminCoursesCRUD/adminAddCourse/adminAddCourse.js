...
import './adminAddCourse.module.css';
import {API_Admin_AddCourse} from '../../../../../constants/contant';
import adminAddCourseValidationSchema from "../../../../../services/validationService/adminJoiValidation/adminAddCourseValidation/adminAddCourseVaidation";
...
let AddCource = () => {
  ...
  const navigate = useNavigate();
      ...
      let validateProperty = (name, value) => {
            let obj = { [name]: value };
            let subSchema = { [name]: adminAddCourseValidationSchema[name] };
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error);
        ...
        let isValid = true;
        for (let field in adminAddCourseValidationSchema) {
